...
const Index = (props) => {
  ...
  return (
    <React.Fragment>
          ...
          <Fade right>
            <section className="home__text">
              ...
              <p>
                ...
                ut pariatur incididunt tempor. Labore labore ipsum adipisicing
                anim laborum est quis irure labore enim nostrud consequat
                aliquip. Mollit aliqua ullamco magna irure consectetur
                consectetur.
              </p>
            </section>
          </Fade>
      ...
      <ShortLive setIsLoading={props.setIsLoading} />
      <ShortAbout setIsLoading={props.setIsLoading} />
      <EventList setIsLoading={props.setIsLoading} />
    </React.Fragment>
  );
};
